...
class PutQuestion extends Component {
  ...
  componentDidUpdate(prevProps) {
    if (prevProps.number !== this.props.number) {
      ...
      this.setState({ answer: this.props.answer }, () => {
        if (
          this.props.question.questiontype === "Numerical" &&
          !this.props.answer
        ) {
        ...
        if (
          this.props.question.questiontype === "Multiple-Correct" &&
  ...
  handle_checkbox(e) {
    ...
    if (e.target.id === "op1") ans.a = e.target.checked;
    else if (e.target.id === "op2") ans.b = e.target.checked;
    else if (e.target.id === "op3") ans.c = e.target.checked;
    else if (e.target.id === "op4") ans.d = e.target.checked;
      ...
      <div id={"question".concat(this.props.number)}>
        ...
        <div className="question">
          <div className="subquestion-metainfo">
            <h4>
              <p />
              <b style={{ color: "red" }}>Q{this.props.number + 1}</b>
              <p />
            ...
            {this.props.question.questiontype === "Single-Correct" ? (
              ...
              <div>
                <div className="form-check">
                  <input
                    className="form-check-input"
                    checked={this.state.answer && this.state.answer.a}
                ...
                <div className="form-check">
                  <input
                    className="form-check-input"
                    checked={this.state.answer && this.state.answer.b}
                    onChange={this.handle_checkbox}
                    type="checkbox"
                    value="true"
                    id="op2"
                ...
                <div className="form-check">
                  <input
                    className="form-check-input"
                    checked={this.state.answer && this.state.answer.c}
                    onChange={this.handle_checkbox}
                    type="checkbox"
                    value="true"
                    id="op3"
                ...
                <div className="form-check">
                  <input
                    className="form-check-input"
                    checked={this.state.answer && this.state.answer.d}
                    onChange={this.handle_checkbox}
                    type="checkbox"
                    value="true"
                    id="op4"
